        ...
        <div class="content-body">
            <div class="row row-xs " style="margin: 20px 100px 0px 100px;">
                <div class="component-section no-code ">
                    <form action="<?php echo base_url();?>index.php/AdminCustomer/createCustomer" class="shadow rounded  px-5 py-5 " style="border-radius: 30px !important; " enctype="multipart/form-data" method="post">
                        <div class="row row-sm ">
                            <div class="col-sm-5 pr-5 mg-t-30">
                                <label for="inputEmail4" class="form-label"></label>
                                <input type="text" class="form-control rounded py-4 shadow shadow service-input-box" placeholder="Name" name="name">
                            </div>
                            <div class="col-sm-5 mx-5 mg-t-30">
                                <label for="inputEmail4" class="form-label"></label>
                                <input type="text" class="form-control rounded py-4 shadow shadow service-input-box" placeholder="User Name" name="username">
                            </div>
							<div class="col-sm-5 pr-5 mg-t-30">
                                <label for="inputEmail4" class="form-label"></label>
                                <input type="password" class="form-control rounded py-4 shadow shadow service-input-box" placeholder="Password" name="password">
                            </div>
                            <div class="col-sm-5 mx-5 mg-t-30">
                                <label for="inputEmail4" class="form-label"></label>
                                <input type="text" class="form-control rounded py-4 shadow shadow service-input-box" placeholder="Last Active"  name="lastActive">
                            </div>
							<div class="col-sm-5 pr-5 mg-t-30">
                                <label for="inputEmail4" class="form-label"></label>
                                <input type="text" class="form-control rounded py-4 shadow shadow service-input-box" placeholder="Date Registered" name="dateRegister">
                            </div>
                            <div class="col-sm-5 mx-5 mg-t-30">
                                <label for="inputEmail4" class="form-label"></label>
                                <input type="email" class="form-control rounded py-4 shadow shadow service-input-box" placeholder="Email" name="email">
                            </div>
							<div class="col-sm-5 pr-5 mg-t-30">
                                <label for="inputEmail4" class="form-label"></label>
                                <input type="text" class="form-control rounded py-4 shadow shadow service-input-box" placeholder="Projects" name="projects">
                            </div>
                            <div class="col-sm-5 mx-5 mg-t-30">
                                <label for="inputEmail4" class="form-label"></label>
                                <input type="text" class="form-control rounded py-4 shadow shadow service-input-box" placeholder="Total Spend" name="totalSpend">
                            </div>
							<div class="col-sm-5 pr-5 mg-t-30">
                                <label for="inputEmail4" class="form-label"></label>
                                <input type="text" class="form-control rounded py-4 shadow shadow service-input-box" placeholder="AOV Avergae order value" name="aov">
                            </div>
                            <div class="col-sm-5 mx-5 mg-t-30">
                                <label for="inputEmail4" class="form-label"></label>
                                <input type="text" class="form-control rounded py-4 shadow shadow service-input-box" placeholder="Country" name="country">
                            </div>
							<div class="col-sm-5 pr-5 mg-t-30">
                                <label for="inputEmail4" class="form-label"></label>
                                <input type="text" class="form-control rounded py-4 shadow shadow service-input-box" placeholder="City" name="city">
                            </div>
                            <div class="col-sm-5 mx-5 mg-t-30">
                                <label for="inputEmail4" class="form-label"></label>
                                <input type="text" class="form-control rounded py-4 shadow shadow service-input-box" placeholder="Region" name="region">
                            </div>
							<div class="col-sm-5 mg-t-30">
                                <label for="inputEmail4" class="form-label"></label>
                                <input type="text" class="form-control rounded py-4 shadow shadow service-input-box" placeholder="Postal Code" name="postalCode">
                            </div>

							<div class="col-md-12 mg-t-30 rounded mb-5">
                                <button type="submit" class="btn btn-secondary py-2 px-4 service-input-box">Create Package</button>
                            </div>
