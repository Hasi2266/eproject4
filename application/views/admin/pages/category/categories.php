                ...
                <table id="example1" class="table" style="border-radius:10px ;font-size:13px">
                    <thead>
                        <tr>
                           ...
                           <th></th>
                            <th class="wd-20p" ><span style="margin-left:-4rem;">Category Name<span></th>
                            <th >Parent Name</th>
                            <th >Created Date</th>
							<th >Actions</th>
						...
						?> -->
                            ...
                            <td><?php echo $item->category_created_date?></td>
                               ...
                               <div class="dropdown">
                                ...
                                <a  class="dropdown-item" href="<?php echo base_url();?>index.php/AdminCategory/editItem/<?php echo $item->category_id?>"><i data-feather="edit" class="svg-16 mx-1 text-dark"></i><span>  Edit <span></a>
                                <a  class="dropdown-item" href="<?php echo base_url();?>index.php/AdminCategory/deleteItem/<?php echo $item->category_id?>" class=""><i data-feather="delete" class="svg-16 mx-1 text-dark"></i>Delete</a>
