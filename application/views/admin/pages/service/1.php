        ...
        <div class="pd-x-65 pd-b-15">
            ...
            <div class="component-section px-5 shadow" style="border-radius: 13px;">
                ...
                <table id="example1" class="table1 table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="wd-12p">Service Name </th>
				...
				<?php foreach($items as $item){?>
                        <tr data-url="<?php echo base_url()?>index.php/AdminService/displayService/<?php echo $item->service_id ?>" style="cursor:pointer;">
						...
						?>
                            <td>
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="<?php echo $item->service_id ?>">
                                    <label class="custom-control-label" for="<?php echo $item->service_id ?>"></label>
                                </div>
                            </td>
