    ...
    <!-- sidebar -->
        ...
        <div class="card card-hover card-projects  card-task-one dashCardHover content-card-body mt-4" style="border-radius: 10px;margin-bottom:2rem !important;padding-bottom:3rem; " >
				...
				<div class="card-header bg-transparent pd-y-15 pd-l-15 pd-r-10" style="margin-bottom:-0.1rem;">
									<h6 class="card-title mg-b-0 px-1" style="margin-top:1px;margin-bottom:-6px">Add Service</h6>
									<!-- <nav class="nav">
					...
					<form  class="all-form" action="<?php echo base_url();?>index.php/AdminService/saveService" enctype="multipart/form-data" method="post">
                        <div class="row row-sm">
							...
							<div class="col-sm-6 mg-t-30 ml-auto" style="margin-left: -15px; ">
								<input type="text "class=" borderRa form-control  py-2 service-input-box" style="padding-right: 0px;border-radius:8px " placeholder="Price" name="price">
                            </div>
                            ...
                            <div class="all-btns" > 
                                <button type="submit" class="btn btn-all btn-submit btn-dark btn-new mt-2">Create</button>
                                <a href="<?php echo base_url();?>index.php/AdminService/allServices"><button type="button" class="btn btn-submit btn-all btn-dark btn-new mt-2 px-5" style="margin-left:0.5rem" >Back</button></a>
                             </div>
                        </div>
                        <!-- row -->
                    </div>
